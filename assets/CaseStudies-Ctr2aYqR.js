...
`),o=i.map(e=>e.autor).filter(Boolean),s=[...new Set(o)].join(` & `),c=[];i.forEach(e=>{e.imagens&&(c=[...c,...e.imagens])});let l={id:Date.now().toString(36)+Math.random().toString(36).substr(2,5),texto:a,autor:s||`Autores Mesclados`,imagens:c,finalizado:!1,emPauta:!1,inviavel:!1,criadoEm:Date.now()},u=r.filter(e=>!X.includes(e.id));u.push(l),t.update(e,{ideias:u})}),Y(!1),Z([])}catch(e){console.error(e),alert(`Erro ao mesclar ideias.`)}},Re=()=>{if(!k)return;let e=document.getElementById(`print-iframe`);e||(e=document.createElement(`iframe`),e.id=`print-iframe`,e.style.position=`absolute`,e.style.width=`0px`,e.style.height=`0px`,e.style.border=`none`,document.body.appendChild(e));let t=`
    ...
    `,n=e.contentWindow.document;n.open(),n.write(t),n.close(),setTimeout(()=>{e.contentWindow.focus(),e.contentWindow.print()},500)};return(0,O.jsxs)(_.div,{className:`case-studies-container ${p}`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},transition:{duration:.4},children:[(0,O.jsxs)(`div`,{className:`cs-header no-print`,children:[(0,O.jsxs)(`h1`,{children:[(0,O.jsx)(g,{className:`cs-icon`,size:32}),`Banco de Ideias (Módulos)`]}),(0,O.jsxs)(`div`,{className:`header-actions`,children:[!k&&(0,O.jsxs)(`button`,{className:`print-btn`,onClick:()=>{let e=document.getElementById(`print-iframe`);e||(e=document.createElement(`iframe`),e.id=`print-iframe`,e.style.position=`absolute`,e.style.width=`0px`,e.style.height=`0px`,e.style.border=`none`,document.body.appendChild(e));let t=`
      <!DOCTYPE html>
      <html>
        <head>
    ...
    `,n=e.contentWindow.document;n.open(),n.write(t),n.close(),setTimeout(()=>{e.contentWindow.focus(),e.contentWindow.print()},250)},title:`Imprimir Relatório em PDF`,children:[(0,O.jsx)(s,{size:18}),` Imprimir Relatório`]}),(0,O.jsxs)(`button`,{className:`back-btn`,onClick:e,children:[(0,O.jsx)(f,{size:18}),` Voltar ao Dashboard`]})]})]}),(0,O.jsx)(`div`,{className:`cs-content no-print`,children:(0,O.jsx)(v,{mode:`wait`,children:k?(()=>{if(!k)return null;let e=[...ve?k.ideias||[]:(k.ideias||[]).filter(e=>!e.finalizado)].sort((e,t)=>{let n=e.finalizado||e.inviavel;return n===(t.finalizado||t.inviavel)?!n&&e.emPauta!==t.emPauta?e.emPauta?-1:1:t.criadoEm-e.criadoEm:n?1:-1});return(0,O.jsxs)(_.div,{initial:{opacity:0,x:20},animate:{opacity:1,x:0},exit:{opacity:0,x:20},className:`details-view`,children:[(0,O.jsxs)(`div`,{className:`details-header-bar`,style:{justifyContent:`space-between`},children:[(0,O.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`20px`},children:[(0,O.jsxs)(`button`,{className:`btn-back-topic`,onClick:()=>A(null),children:[(0,O.jsx)(f,{size:18}),` Voltar para Módulos`]}),(0,O.jsx)(`h2`,{style:{margin:0},children:k.titulo})]}),(0,O.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`12px`},children:[(0,O.jsxs)(`button`,{className:`print-btn`,onClick:()=>Y(!J),title:`Mesclar Ideias Similares`,style:{borderColor:J?`var(--neon-cyan)`:``,color:J?`var(--neon-cyan)`:``},children:[(0,O.jsx)(c,{size:18}),` `,J?`Cancelar Mesclagem`:`Mesclar Ideias`]}),(0,O.jsxs)(`button`,{className:`print-btn`,onClick:Re,title:`Imprimir Ideias deste Módulo`,children:[(0,O.jsx)(s,{size:18}),` Imprimir Módulo`]})]})]}),(0,O.jsxs)(`div`,{className:`idea-form-container`,children:[(0,O.jsx)(`h3`,{children:`Sugerir Melhoria`}),(0,O.jsxs)(`form`,{onSubmit:De,className:`idea-form`,children:[(0,O.jsx)(`textarea`,{placeholder:`Descreva a melhoria ou ideia para este módulo...`,value:N,onChange:e=>P(e.target.value),required:!0,rows:3}),(0,O.jsxs)(`div`,{className:`idea-form-footer`,children:[(0,O.jsxs)(`div`,{className:`input-with-icon file-upload-wrapper`,children:[(0,O.jsx)(`input`,{type:`file`,accept:`image/*`,multiple:!0,onChange:Ee,id:`idea-images-input`,style:{display:`none`},disabled:z}),(0,O.jsxs)(`label`,{htmlFor:`idea-images-input`,className:`btn-icon`,style:{cursor:`pointer`,display:`flex`,alignItems:`center`,gap:`6px`},children:[(0,O.jsx)(oe,{size:18}),L.length>0?`${L.length} img(s)`:`Anexar Imagens`]})]}),(0,O.jsxs)(`div`,{className:`input-with-icon`,children:[(0,O.jsx)(re,{size:16}),(0,O.jsx)(`input`,{type:`text`,placeholder:`Seu nome`,value:F,onChange:e=>I(e.target.value),required:!0,disabled:z})]}),(0,O.jsxs)(`button`,{type:`submit`,className:`btn-primary`,disabled:z,children:[z?(0,O.jsx)(te,{size:18,className:`spin-icon`}):(0,O.jsx)(g,{size:18}),z?`Enviando...`:`Adicionar Ideia`]})]})]})]}),(0,O.jsxs)(`div`,{className:`ideas-list-container`,children:[(0,O.jsxs)(`div`,{className:`ideas-list-header`,children:[(0,O.jsx)(`h3`,{children:`Lista de Ideias`}),(0,O.jsxs)(`div`,{style:{display:`flex`,gap:`16px`,alignItems:`center`},children:[J&&(0,O.jsxs)(`div`,{style:{display:`flex`,gap:`8px`,alignItems:`center`,background:`var(--surface-hover)`,padding:`6px 12px`,borderRadius:`8px`},children:[(0,O.jsxs)(`span`,{style:{fontSize:`0.85rem`,color:`var(--text-primary)`,fontWeight:`bold`},children:[X.length,` marcadas`]}),X.length>=2&&(0,O.jsx)(`button`,{className:`btn-primary small`,onClick:Le,style:{padding:`4px 10px`,fontSize:`0.8rem`},children:`Mesclar`}),(0,O.jsx)(`button`,{className:`btn-icon small`,onClick:()=>{Y(!1),Z([])},children:(0,O.jsx)(h,{size:14})})]}),(0,O.jsxs)(`label`,{className:`toggle-completed`,children:[(0,O.jsx)(`input`,{type:`checkbox`,checked:ve,onChange:e=>ye(e.target.checked)}),`Mostrar finalizadas`]})]})]}),(0,O.jsxs)(`div`,{className:`ideas-list`,children:[(0,O.jsx)(v,{children:e.map(e=>(0,O.jsxs)(_.div,{className:`idea-card ${e.finalizado?`finalizada`:``} ${e.inviavel?`inviavel`:``} ${e.viavel?`viavel`:``} ${J&&X.includes(e.id)?`selected-merge`:``}`,initial:{opacity:0,y:10},animate:{opacity:1,y:0},exit:{opacity:0,scale:.95},layout:!0,onClick:()=>{J&&Ie(e.id)},style:{cursor:J?`pointer`:`default`},children:[J&&(0,O.jsx)(`div`,{className:`merge-checkbox`,style:{display:`flex`,alignItems:`center`,marginRight:`16px`},children:(0,O.jsx)(`input`,{type:`checkbox`,checked:X.includes(e.id),readOnly:!0,style:{width:`20px`,height:`20px`,cursor:`pointer`}})}),!J&&(0,O.jsx)(`button`,{className:`status-toggle`,onClick:()=>ke(e.id),title:e.finalizado?`Marcar como pendente`:`Marcar como finalizado`,children:e.finalizado?(0,O.jsx)(d,{size:24,className:`icon-success`}):(0,O.jsx)(n,{size:24,className:`icon-pending`})}),(0,O.jsx)(`div`,{className:`idea-content`,children:me===e.id?(0,O.jsxs)(`div`,{className:`idea-edit-mode`,children:[(0,O.jsx)(`textarea`,{value:G,onChange:e=>he(e.target.value),rows:3,autoFocus:!0,disabled:z}),(0,O.jsxs)(`div`,{className:`edit-images-section`,style:{marginTop:`10px`},children:[K.length>0&&(0,O.jsx)(`div`,{className:`idea-images-grid`,style:{display:`flex`,gap:`10px`,flexWrap:`wrap`,marginBottom:`10px`},children:K.map((e,t)=>(0,O.jsxs)(`div`,{style:{position:`relative`,width:`60px`,height:`60px`,borderRadius:`6px`,overflow:`hidden`,border:`1px solid var(--border-light)`},children:[(0,O.jsx)(`img`,{src:e.url,alt:e.nome,style:{width:`100%`,height:`100%`,objectFit:`cover`}}),(0,O.jsx)(`button`,{className:`remove-image-btn`,onClick:()=>ge(e=>e.filter((e,n)=>n!==t)),disabled:z,style:{position:`absolute`,top:2,right:2,background:`rgba(239,68,68,0.9)`,border:`none`,borderRadius:`50%`,width:`20px`,height:`20px`,display:`flex`,alignItems:`center`,justifyContent:`center`,color:`white`,cursor:`pointer`},title:`Remover imagem`,children:(0,O.jsx)(h,{size:12})})]},t))}),q.length>0&&(0,O.jsxs)(`div`,{style:{fontSize:`0.85rem`,color:`var(--neon-cyan)`,marginBottom:`10px`},children:[`+ `,q.length,` novo(s) arquivo(s) selecionado(s)`]})]}),(0,O.jsxs)(`div`,{className:`idea-edit-actions`,style:{display:`flex`,justifyContent:`space-between`,marginTop:`10px`},children:[(0,O.jsxs)(`div`,{children:[(0,O.jsx)(`input`,{type:`file`,accept:`image/*`,multiple:!0,onChange:e=>{e.target.files&&_e(Array.from(e.target.files))},id:`edit-images-input-${e.id}`,style:{display:`none`},disabled:z}),(0,O.jsxs)(`label`,{htmlFor:`edit-images-input-${e.id}`,className:`btn-icon small`,style:{cursor:`pointer`,background:`var(--surface-hover)`,padding:`6px 12px`},children:[(0,O.jsx)(oe,{size:14,style:{marginRight:`6px`}}),` Anexar`]})]}),(0,O.jsxs)(`div`,{style:{display:`flex`,gap:`8px`},children:[(0,O.jsxs)(`button`,{className:`btn-primary small`,onClick:()=>Me(e.id),disabled:z,children:[z?(0,O.jsx)(te,{size:14,className:`spin-icon`}):(0,O.jsx)(r,{size:14}),` `,z?`Salvando...`:`Salvar`]}),(0,O.jsx)(`button`,{className:`btn-icon small`,onClick:()=>W(null),disabled:z,children:`Cancelar`})]})]})]}):(0,O.jsxs)(O.Fragment,{children:[(0,O.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`,marginBottom:`8px`,flexWrap:`wrap`},children:[e.emPauta&&!e.finalizado&&(0,O.jsx)(`span`,{className:`badge-pauta`,children:`Em Pauta`}),e.viavel&&(0,O.jsx)(`span`,{className:`badge-viavel`,style:{background:`rgba(16, 185, 129, 0.15)`,color:`#10b981`,border:`1px solid rgba(16, 185, 129, 0.3)`,padding:`3px 10px`,borderRadius:`12px`,fontSize:`0.78rem`,fontWeight:600,display:`inline-flex`,alignItems:`center`,gap:`5px`},children:`✅ VIÁVEL — Providenciar dados para solicitação`}),e.inviavel&&(0,O.jsx)(`span`,{className:`badge-inviavel`,style:{background:`rgba(239, 68, 68, 0.15)`,color:`#ef4444`,border:`1px solid rgba(239, 68, 68, 0.3)`,padding:`3px 10px`,borderRadius:`12px`,fontSize:`0.78rem`,fontWeight:600},children:`🚫 INVIÁVEL`})]}),(0,O.jsx)(`p`,{className:`idea-text`,children:e.texto}),e.imagens&&e.imagens.length>0&&(0,O.jsx)(`div`,{className:`idea-images-grid`,style:{display:`flex`,gap:`10px`,marginTop:`10px`,flexWrap:`wrap`},children:e.imagens.map((e,t)=>(0,O.jsxs)(`a`,{href:e.url,onClick:t=>Oe(t,e.url,e.nome),className:`idea-image-link`,title:`Ver/Baixar: ${e.nome}`,style:{position:`relative`,width:`80px`,height:`80px`,borderRadius:`8px`,overflow:`hidden`,border:`1px solid var(--border-light)`,display:`block`},children:[(0,O.jsx)(`img`,{src:e.url,alt:e.nome,style:{width:`100%`,height:`100%`,objectFit:`cover`}}),(0,O.jsx)(`div`,{className:`idea-image-overlay`,style:{position:`absolute`,top:0,left:0,right:0,bottom:0,background:`rgba(0,0,0,0.5)`,display:`flex`,alignItems:`center`,justifyContent:`center`,opacity:0,transition:`opacity 0.2s ease`,color:`white`},children:(0,O.jsx)(ne,{size:20})})]},t))}),(0,O.jsxs)(`div`,{className:`idea-meta`,children:[(0,O.jsxs)(`span`,{className:`author`,children:[(0,O.jsx)(re,{size:12}),` `,e.autor]}),(0,O.jsxs)(`span`,{className:`date`,children:[(0,O.jsx)(u,{size:12}),` `,new Date(e.criadoEm).toLocaleDateString(`pt-BR`)]})]}),be===e.id?(0,O.jsxs)(`div`,{className:`obs-dev-editor`,style:{marginTop:`14px`,padding:`12px`,background:`rgba(6, 182, 212, 0.08)`,border:`1px solid rgba(6, 182, 212, 0.35)`,borderRadius:`8px`,width:`100%`},onClick:e=>e.stopPropagation(),children:[(0,O.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`6px`,color:`#06b6d4`,fontWeight:600,fontSize:`0.82rem`,marginBottom:`8px`},children:[(0,O.jsx)(o,{size:16}),` OBSERVAÇÃO DESENVOLVIMENTO:`]}),(0,O.jsx)(`textarea`,{value:xe,onChange:e=>$(e.target.value),placeholder:`Digite o comentário ou observação do desenvolvimento sobre esta ideia...`,rows:3,style:{width:`100%`,padding:`8px 10px`,borderRadius:`6px`,border:`1px solid var(--border-light)`,background:`var(--bg-primary)`,color:`var(--text-primary)`,fontSize:`0.88rem`,fontFamily:`inherit`},autoFocus:!0}),(0,O.jsxs)(`div`,{style:{display:`flex`,justifyContent:`flex-end`,gap:`8px`,marginTop:`10px`},children:[(0,O.jsxs)(`button`,{className:`btn-primary small`,onClick:t=>{t.stopPropagation(),Fe(e.id)},children:[(0,O.jsx)(r,{size:14}),` Salvar Observação`]}),(0,O.jsx)(`button`,{className:`btn-icon small`,onClick:e=>{e.stopPropagation(),Q(null)},children:`Cancelar`})]})]}):e.obsDesenvolvimento&&(0,O.jsxs)(`div`,{className:`obs-dev-box`,style:{marginTop:`14px`,padding:`10px 14px`,background:`rgba(6, 182, 212, 0.08)`,borderLeft:`3px solid #06b6d4`,borderRadius:`6px`,fontSize:`0.88rem`,width:`100%`},children:[(0,O.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,marginBottom:`4px`},children:[(0,O.jsxs)(`strong`,{style:{color:`#06b6d4`,fontSize:`0.78rem`,display:`flex`,alignItems:`center`,gap:`6px`},children:[(0,O.jsx)(o,{size:14}),` OBSERVAÇÃO DESENVOLVIMENTO:`]}),(0,O.jsx)(`button`,{onClick:t=>{t.stopPropagation(),Q(e.id),$(e.obsDesenvolvimento||``)},style:{background:`transparent`,border:`none`,color:`var(--text-secondary)`,cursor:`pointer`,padding:`2px`},title:`Editar observação do desenvolvimento`,children:(0,O.jsx)(l,{size:13})})]}),(0,O.jsx)(`p`,{style:{margin:0,color:`var(--text-primary)`,whiteSpace:`pre-wrap`,lineHeight:1.4},children:e.obsDesenvolvimento})]})]})}),me!==e.id&&(0,O.jsxs)(`div`,{className:`idea-actions`,children:[(0,O.jsx)(`button`,{className:`btn-icon ${e.obsDesenvolvimento?`active-pin`:``}`,onClick:t=>{t.stopPropagation(),Q(e.id),$(e.obsDesenvolvimento||``)},title:`Observação Desenvolvimento`,style:e.obsDesenvolvimento?{background:`rgba(6, 182, 212, 0.15)`,color:`#06b6d4`,borderColor:`rgba(6, 182, 212, 0.4)`}:void 0,children:(0,O.jsx)(o,{size:16})}),(0,O.jsx)(`button`,{className:`btn-icon ${e.viavel?`success`:``}`,onClick:t=>{t.stopPropagation(),Pe(e.id)},title:e.viavel?`Remover viável`:`Marcar como Viável`,style:e.viavel?{color:`#10b981`,borderColor:`#10b981`,background:`rgba(16, 185, 129, 0.15)`}:void 0,children:(0,O.jsx)(ee,{size:16})}),(0,O.jsx)(`button`,{className:`btn-icon ${e.emPauta?`active-pin`:``}`,onClick:t=>{t.stopPropagation(),Ae(e.id)},title:e.emPauta?`Remover de pauta`:`Marcar como pauta principal`,children:(0,O.jsx)(a,{size:16})}),(0,O.jsx)(`button`,{className:`btn-icon ${e.inviavel?`danger`:``}`,onClick:t=>{t.stopPropagation(),Ne(e.id)},title:e.inviavel?`Remover inviável`:`Marcar como Inviável`,children:(0,O.jsx)(t,{size:16})}),(0,O.jsx)(`button`,{className:`btn-icon edit-idea`,onClick:t=>{t.stopPropagation(),W(e.id),he(e.texto),ge(e.imagens||[]),_e([])},title:`Editar Ideia`,children:(0,O.jsx)(l,{size:16})}),(0,O.jsx)(`button`,{className:`btn-icon danger delete-idea`,onClick:t=>{t.stopPropagation(),je(e.id)},title:`Apagar Ideia`,children:(0,O.jsx)(ie,{size:16})})]})]},e.id))}),e.length===0&&(0,O.jsx)(`div`,{className:`empty-state`,children:`Nenhuma ideia para exibir.`})]})]})]},`topic-details`)})():(()=>{let e=[...m].sort((e,t)=>e.emPauta===t.emPauta?(t.criadoEm||0)-(e.criadoEm||0):e.emPauta?-1:1);return(0,O.jsxs)(_.div,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},exit:{opacity:0,x:-20},className:`topics-view`,children:[(0,O.jsxs)(`div`,{className:`module-form-container`,children:[(0,O.jsx)(`h2`,{children:`Criar Novo Módulo`}),(0,O.jsxs)(`form`,{onSubmit:Se,className:`module-form`,children:[(0,O.jsx)(`input`,{type:`text`,placeholder:`Ex: DFE, Devolução de Compra...`,value:j,onChange:e=>M(e.target.value),required:!0}),(0,O.jsxs)(`button`,{type:`submit`,className:`btn-primary`,children:[(0,O.jsx)(i,{size:18}),` Adicionar`]})]})]}),(0,O.jsxs)(`div`,{className:`topics-grid`,children:[(0,O.jsx)(v,{children:e.map(e=>(0,O.jsxs)(_.div,{className:`topic-card ${e.emPauta?`topic-pauta`:``}`,initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.95},layout:!0,onClick:()=>{V!==e.id&&A(e)},children:[(0,O.jsx)(`div`,{className:`topic-card-header ${V===e.id?`is-editing`:``}`,children:V===e.id?(0,O.jsxs)(`div`,{className:`topic-edit-mode`,onClick:e=>e.stopPropagation(),children:[(0,O.jsx)(`input`,{type:`text`,value:U,onChange:e=>pe(e.target.value),autoFocus:!0}),(0,O.jsxs)(`div`,{className:`topic-edit-actions`,children:[(0,O.jsxs)(`button`,{className:`btn-primary small`,onClick:t=>we(t,e.id),children:[(0,O.jsx)(r,{size:14}),` Salvar`]}),(0,O.jsxs)(`button`,{className:`btn-icon`,onClick:()=>H(null),children:[(0,O.jsx)(h,{size:14}),` Cancelar`]})]})]}):(0,O.jsxs)(O.Fragment,{children:[(0,O.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`4px`},children:[e.emPauta&&(0,O.jsx)(`span`,{className:`badge-pauta`,style:{alignSelf:`flex-start`,marginBottom:`4px`},children:`Em Pauta`}),(0,O.jsx)(`h3`,{children:e.titulo})]}),(0,O.jsxs)(`div`,{className:`topic-actions`,onClick:e=>e.stopPropagation(),children:[(0,O.jsx)(`button`,{className:`btn-icon ${e.emPauta?`active-pin`:``}`,onClick:t=>Te(t,e.id,e.emPauta),title:e.emPauta?`Remover de pauta`:`Marcar módulo em pauta`,children:(0,O.jsx)(a,{size:16})}),(0,O.jsx)(`button`,{className:`btn-icon`,onClick:t=>{t.stopPropagation(),H(e.id),pe(e.titulo)},title:`Editar Módulo`,children:(0,O.jsx)(l,{size:16})}),(0,O.jsx)(`button`,{className:`btn-icon danger`,onClick:t=>Ce(t,e.id),title:`Apagar Módulo`,children:(0,O.jsx)(ie,{size:16})})]})]})}),(0,O.jsxs)(`div`,{className:`topic-card-stats`,children:[(0,O.jsxs)(`span`,{className:`stat-badge`,children:[(0,O.jsx)(g,{size:14}),(e.ideias||[]).length,` Ideias`]}),(0,O.jsxs)(`span`,{className:`stat-badge success`,children:[(0,O.jsx)(d,{size:14}),(e.ideias||[]).filter(e=>e.finalizado).length,` Resolvidas`]})]}),(0,O.jsxs)(`div`,{className:`topic-card-arrow`,children:[`Acessar Módulo `,(0,O.jsx)(ae,{size:18})]})]},e.id))}),e.length===0&&(0,O.jsx)(`div`,{className:`empty-state`,children:`Nenhum módulo cadastrado ainda.`})]})]},`topics-list`)})()})})]})};export{fe as default};